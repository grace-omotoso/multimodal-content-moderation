...
async def moderate_image(
    ...
    # Run the image_moderation_agent with a list containing a prompt and image_input,then return result.output
    prompt = "Analyze this image for moderation purposes."
    result = await image_moderation_agent.run([prompt, image_input], model=model_choice.model, model_settings=model_choice.model_settings)
